...
const BlogSection = () => {
  ...
  const featuredPost = {
    ...
    imageUrl: 'https://img.freepik.com/free-photo/pre-prepared-food-showcasing-ready-eat-delicious-meals-go_23-2151246066.jpg?ga=GA1.1.1782891138.1747143947&semt=ais_items_boosted&w=740',
  };  
  ...
  const posts = [
    {
      ...
      date: 'January 3, 2025',
      imageUrl: 'https://img.freepik.com/free-photo/maki-roll-with-cucumber-served-with-sauce-sesame-seeds_141793-790.jpg?ga=GA1.1.1782891138.1747143947&semt=ais_items_boosted&w=740',
    },
    {
      id: 3,
      title: 'Exclusive baking lesson from the pastry king',
      date: 'February 13, 2025',
      imageUrl: 'https://img.freepik.com/free-photo/chocolate-puff-pastry-croissant-chocolate-eclair-sweet-raisin-roll_140725-5637.jpg?ga=GA1.1.1782891138.1747143947&semt=ais_items_boosted&w=740',
    },
    {
      id: 4,
      title: 'How to prepare the perfect fries in an air fryer',
      date: 'March 6, 2025',
      imageUrl: 'https://img.freepik.com/free-photo/grilled-beef-fries-hearty-lunch-generated-by-ai_188544-37376.jpg?ga=GA1.1.1782891138.1747143947&semt=ais_items_boosted&w=740',
    },
    {
      id: 5,
      title: 'How to prepare delicious chicken tenders',
      date: 'March 24, 2025',
      imageUrl: 'https://img.freepik.com/free-photo/fried-chicken-french-fries-black-cement-floor_1150-28542.jpg?ga=GA1.1.1782891138.1747143947&semt=ais_items_boosted&w=740',
    },
  ];
  ...
  return (
    <section className="bg-white py-16">
      ...
      {/* Blog Content */}
      <div className="container mx-auto px-4 mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Featured Post */}
